    ...
    <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
        <div className="lg:col-span-2 flex flex-col gap-8">
          ...
          {/* Deskripsi */}
          <Card title="Deskripsi" icon={<FileText />}>
          ...
          <Card title="Legalitas & Pajak" icon={<ShieldCheck />}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <InfoItem label="Serah Terima" value={fmtNum(detail.handoverDate)} icon={<Calendar className="w-5 h-5" />} />
              <InfoItem label="Tahun Dibangun" value={detail.yearBuilt ?? "-"} icon={<Calendar className="w-5 h-5" />} />
              <InfoItem label="Ketersediaan" value={fmtNum(detail.availabilityDate)} icon={<Calendar className="w-5 h-5" />} />
            </div>
          </Card>
