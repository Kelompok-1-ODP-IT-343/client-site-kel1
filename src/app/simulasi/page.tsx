...
export default function SimulasiKprPage() {
  ...
  const { rows, totalPembayaran, totalBunga } = useMemo(() => {
    if (rateSegments.length === 0)
      return { rows: [], totalPembayaran: 0, totalBunga: 0 };
  ...
  const [schemeType, setSchemeType] = useState<"single_fixed" | "tiered">(
    "single_fixed"
  );
  ...
  > = {
    single_fixed: {
      A: {
        ...
        "4": { "Bunga Tetap 4 Tahun": 8.0 },
        "5": { "Bunga Tetap 3 Tahun": 6.75, "Bunga Tetap 5 Tahun": 8.0 },
        "6": { "Bunga Tetap 6 Tahun": 8.0 },
        "7": { "Bunga Tetap 7 Tahun": 8.0 },
        "8": { "Bunga Tetap 8 Tahun": 8.0 },
        "9": { "Bunga Tetap 9 Tahun": 8.25 },
        "10": {
          "Bunga Tetap 3 Tahun": 3.75,
          "Bunga Tetap 5 Tahun": 5.75,
          "Bunga Tetap 10 Tahun": 8.25,
        },
        "12": { "Bunga Tetap 5 Tahun": 4.75 },
        "15": { "Bunga Tetap 3 Tahun": 2.75, "Bunga Tetap 5 Tahun": 3.75 },
        "20": {
          "Bunga Tetap 3 Tahun": 4.0,
          "Bunga Tetap 5 Tahun": 6.0,
          "Bunga Tetap 10 Tahun": 8.5,
        },
        "25": {
          "Bunga Tetap 3 Tahun": 4.25,
          "Bunga Tetap 5 Tahun": 6.25,
          "Bunga Tetap 10 Tahun": 8.75,
        },
        "30": {
          "Bunga Tetap 3 Tahun": 4.5,
          "Bunga Tetap 5 Tahun": 6.5,
          "Bunga Tetap 10 Tahun": 9.0,
        },
      },
      B: {
        "1": { "Bunga Tetap 1 Tahun": 8.0 },
        "2": { "Bunga Tetap 2 Tahun": 8.0 },
        "3": { "Bunga Tetap 1 Tahun": 3.25, "Bunga Tetap 3 Tahun": 8.0 },
        ...
        "20": {
          "Bunga Tetap 3 Tahun": 4.75,
          "Bunga Tetap 5 Tahun": 6.75,
          "Bunga Tetap 10 Tahun": 9.25,
        },
        "25": {
          "Bunga Tetap 3 Tahun": 5.25,
          "Bunga Tetap 5 Tahun": 7.25,
          "Bunga Tetap 10 Tahun": 9.75,
        },
        "30": {
          "Bunga Tetap 3 Tahun": 5.75,
          "Bunga Tetap 5 Tahun": 7.75,
          "Bunga Tetap 10 Tahun": 10.25,
        },
      },
    },
    ...
    tiered: {
      A: {
        ...
        "25": {
          ...
          "Tahun ke 4-5": 7.25,
          "Tahun ke 6-10": 9.25,
          "Tahun ke 11-15": 10.75,
          "Tahun ke 16-20": 11.25,
          "Tahun ke 21-25": 11.75,
        },
        "30": {
          "Tahun ke 1": 3.5,
          "Tahun ke 2-3": 5.5,
      ...
      B: {
        ...
        "25": {
          ...
          "Tahun ke 4-5": 7.75,
          "Tahun ke 6-10": 9.75,
          "Tahun ke 11-15": 11.75,
          "Tahun ke 16-20": 12.25,
          "Tahun ke 21-25": 12.75,
        },
        "30": {
          "Tahun ke 1": 4.25,
          "Tahun ke 2-3": 6.25,
          "Tahun ke 4-5": 8.25,
          "Tahun ke 6-10": 10.25,
          "Tahun ke 11-15": 12.25,
          "Tahun ke 16-20": 12.75,
          "Tahun ke 21-25": 13.25,
          "Tahun ke 26-30": 13.75,
        },
      },
    },
  };
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_2fr] gap-8 items-start">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border">
              ...
              <div className="space-y-8">
                ...
                <SliderInput
                  ...
                  formatValue={(val) =>
                    `${val}% (${formatCurrency(hargaProperti * (val / 100))})`
                  }
                />
                ...
                >
                  ...
                  <div className="mb-3">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setSchemeType(
                          e.target.value as "single_fixed" | "tiered"
                        )
                      }
                    >
                  ...
                  <div className="mb-3">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setJangkaWaktu(val);
                        const data =
                          rateData[schemeType]?.[developerType]?.[String(val)];
                    ...
                    >
                      ...
                      {Object.keys(
                        rateData[schemeType]?.[developerType] || {}
                      ).map((key) => (
                    ...
                    Object.keys(selectedRates).length > 0 && (
                      <div className="mb-3">
                        ...
                        >
                          ...
                          {Object.entries(selectedRates).map(
                            ([label, value]) => (
          ...
          >
            ...
            <div
              className="overflow-x-auto border rounded-lg text-gray-600"
              style={{ borderColor: colors.gray + "45" }}
            >
                    ...
                    >
                      ...
                      {r.rateApplied === 0 ? (
                        <>
                          ...
                          <td className="px-4 py-2 italic text-gray-400">-</td>
                          <td className="px-4 py-2 italic text-gray-400">-</td>
                          <td className="px-4 py-2 font-medium text-[#FF8500]">
                            Bunga Floating
                          </td>
                        </>
                      ) : (
                        <>
                          <td className="px-4 py-2">
                            Rp
                            {roundIDR(r.principalComponent).toLocaleString(
                              "id-ID"
                            )}
                          </td>
                          <td className="px-4 py-2">
                            Rp
                            {roundIDR(r.interestComponent).toLocaleString(
                              "id-ID"
                            )}
                          </td>
                          ...
                          <td className="px-4 py-2">
                            Rp{roundIDR(r.balance).toLocaleString("id-ID")}
                          </td>
                          <td className="px-4 py-2">
