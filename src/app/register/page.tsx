...
// You can place your components like Header and Footer here
// import Header from '@/app/components/layout/Header';
// import Footer from '@/app/components/layout/Footer';

// A reusable component for each input field to keep the code clean
...
// A reusable component for each select/dropdown field
...
export default function RegisterPage() {
    ...
    // A simple way to manage form steps
    const steps = [
        { number: 1, title: 'Data Pribadi', icon: <User /> },
        { number: 2, title: 'Alamat', icon: <MapPin /> },
        { number: 3, title: 'Pekerjaan', icon: <Briefcase /> },
        { number: 4, title: 'Informasi KPR', icon: <FileText /> },
        { number: 5, title: 'Akun', icon: <Lock /> },
    ];
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="w-full max-w-4xl bg-white p-8 sm:p-12 rounded-2xl shadow-xl"
            >
                {/* Header Section */}
                    ...
                    {steps.map((step, index) => (
                        <div key={step.number} className="flex items-center">
                            <div className="flex flex-col items-center">
                                ...
                                <p className={`mt-2 text-xs sm:text-sm text-center font-semibold transition-colors ${
                            ...
                            {index < steps.length - 1 && (
                                <div className={`flex-auto border-t-2 transition-all duration-500 mx-2 sm:mx-4 ${
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        {/* You can add content for other steps here */}
                        {currentStep === 2 && <div className="text-center p-8">Halaman Alamat</div>}
                        {currentStep === 3 && <div className="text-center p-8">Halaman Pekerjaan</div>}
                        {currentStep === 4 && <div className="text-center p-8">Halaman Informasi KPR</div>}
                        {currentStep === 5 && <div className="text-center p-8">Halaman Akun</div>}
                    </motion.div>
                </AnimatePresence>
